    ...
    recipes.forEach((recipes)=>{
        document.write(recipes.name+"<br>")
        document.write(recipes.ingredients+"<br>")
        document.write(recipes.instructions+"<br>")
        document.write(recipes.prepTimeMinutes+"<br>")
        document.write(recipes.cookTimeMinutes+"<br>")
        document.write(recipes.servings+"<br>")
        document.write(recipes.difficulty+"<br>")
        document.write(recipes.cuisine+"<br>")
        document.write(recipes.caloriesPerServing+"<br>")
        document.write(recipes.tags+"<br>")
        document.write(recipes.userId+"<br>")
        document.write(recipes.image+"<br>")
        document.write(recipes.rating+"<br>")
        document.write(recipes.reviewCount+"<br>")
        document.write(recipes.mealType+"<br>")
        document.write("<br>")
        document.write("<br>")
    });
